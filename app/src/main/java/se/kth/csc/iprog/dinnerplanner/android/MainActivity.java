    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                                ...
                                                selectedDish = dishesFromAPI.get((int) itemIdAtPosition);
                                                ...
                                                dialogButton.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        dialog.dismiss();
                                                        previousSelectedView.setBackground(getResources().getDrawable(R.drawable.redcolor));
                                                ...
                                                CancelButton.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    @Override
                                                    public void onClick(View v) {
                                                        previousSelectedView.setBackground(getResources().getDrawable(R.drawable.transparent));
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                             ...
                                             public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                                 ...
                                                 this.previousSelectedView = view;
                                                 DishModelSpoon _selectedDish = (DishModelSpoon)parent.getItemAtPosition(position);
        ...
        gridView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                             ...
                                             public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                                ...
                                                parent.getId();
                                                 long itemIdAtPosition = parent.getItemIdAtPosition(position);
                                                 DishModelSpoon _selectedDessert = (DishModelSpoon)desert_list.get(position);
